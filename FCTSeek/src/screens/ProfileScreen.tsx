...
export default function ProfileScreen() {
  ...
  const getInitials = () => {
    return `${currentUser.nombre.charAt(0)}${currentUser.apellidos.charAt(0)}`;
  };
    ...
    <GradientBackground>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.nombre}>{currentUser.nombre} {currentUser.apellidos}</Text>
          <View style={styles.rolBadge}>
            <Text style={styles.rolText}>{currentUser.rol}</Text>
          </View>
        </View>
        ...
        <View style={styles.infoSection}>
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoText}>{currentUser.nif}</Text>
            </View>
            <View style={styles.infoRow}>
